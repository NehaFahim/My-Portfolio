...
const projects: Project[] = [
 
  {
    ...
    description:
      "A simple calculator built with JavaScript. It can perform basic arithmetic operations.",
  ...
  },
  {
    ...
    description:
      "The BMI Calculator is a web application that allows users to calculate their Body Mass Index based on height and weight inputs.",
    image: "/BMI.jpg",
  ...
  },
  {
    title: "ATM Machine",
    description:
      "The ATM Machine project simulates basic banking functions, allowing users to perform transactions like withdrawals and balance inquiries.",
  ...
  },
  {
    title: "QUIZ Built",
    description:
      "The QUIZ Built project is a web application that allows users to take quizzes and test their knowledge on various topics.",
    image: "/quiz.webp",
  ...
  },
  {
    ...
    description:
      "An interactive periodic table displaying all the elements with their properties.",
  ...
  },
  {
    title: "Chess Board",
    description:
      "A classic chess Board built with HTML, allowing two players to play against each other.",
  ...
  },
  {
    ...
    description:
      "A simple website built with HTML, showcasing my first steps in web development.",
    image: "/intrhtml.webp",
  ...
  },
  {
    ...
    description:
      "A project to celebrate the independence of Pakistan, showcasing key historical moments.",
    image: "/flag.jpg",
  ...
  },
  {
    ...
    description:
      "The User Login Form project enables users to securely log in and access their accounts through a simple interface.",
    image: "/login.webp",
  ...
  },
  {
    ...
    description:
      "The NextJS Navbar and Footer project features a responsive navigation bar and footer, enhancing website usability and accessibility across different pages.",
    image: "/web.png",
  ...
  },
  {
    ...
    description:
      "The Student ID Card project in Next.js generates a dynamic digital ID card that displays essential student information in a modern and responsive layout.",
    image: "/idcard.jpg",
  ...
  },
  {
    title: "To-Do-List",
    description:
      'The "To-Do-List" project is a web app for managing tasks, enabling users to add, edit, delete, and mark tasks as complete.',
    image: "/to do.png",
  ...
  },
  {
    ...
    description:
      'The "NextJs HELLO WORLD" project serves as a basic introduction to Next.js, demonstrating how to create a simple web application using this powerful React framework.',
  ...
  },
  {
    ...
    description:
      "The CLI Number Guessing Game is a command-line application that challenges players to guess a randomly generated number within a limited number of attempts.",
    image: "/guess.jpg",
    ...
    <div>
      ...
      <div className="bg-white">
        <div className="container mx-auto p-4 sm:p-6 lg:p-8">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 sm:mb-8 text-center font-serif text-purple-900 underline decoration-yellow-500">
            My Projects
          </h1>
